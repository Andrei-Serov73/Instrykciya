...
1. Выделение заоловков в Markdown происходит при помощи Markdown символа решетка («#»). bla-bla-bka заголовков. Подчеркивание заголовка 1 уровня происходит автоматически, а заголовков 2-6 уровня происходит при помощи символа тире ("-"), причем символов должно быть 3. Уровень заголовка определяется по количеству начальных символов. например: bla-bla-bla/
